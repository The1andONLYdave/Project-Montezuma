...
class LurkerBig extends EnemyTemplate 
{
	...
	override public function update():Void 
	{
		if (touching == FlxObject.DOWN)
		{
			...
			{
				if(Reg.sound==true){FlxG.sound.play("assets/sounds/mondead2" + Reg.SoundExtension, 1, false);}
	...
	override public function hurt(Damage:Float):Void 
	{
		...
		if(Reg.sound==true){FlxG.sound.play("assets/sounds/monhurt2" + Reg.SoundExtension, 1, false);}
		health -= 1;
	}
	...
	private function shoot(P:Player):Void 
	{
		...
		if (_cooldown > GUN_DELAY)
		{
			...
			if(Reg.sound==true){FlxG.sound.play("assets/sounds/badshoot" + Reg.SoundExtension, 1, false);}
