...
ApplicationMain.preload = function() {
	...
	flash.Lib.get_stage().set_frameRate(0);
	...
	ApplicationMain.loadFile("assets/art/simples_pimples - Kopie.png");
	...
	ApplicationMain.loadBinary("assets/levels/1.csv");
	ApplicationMain.loadBinary("assets/levels/background.awk");
	ApplicationMain.loadBinary("assets/levels/ladder-filter.awk");
	ApplicationMain.loadBinary("assets/levels/ladder.awk");
	ApplicationMain.loadBinary("assets/levels/map-it.bat");
	...
	ApplicationMain.loadBinary("assets/levels/practice.awk");
	ApplicationMain.loadFile("assets/levels/unbenannt.png");
	ApplicationMain.loadBinary("assets/levels/unbenannt.tmx");
	ApplicationMain.loadFile("assets/levels/unbenannt2.png");
	ApplicationMain.loadBinary("assets/levels/unbenannt2.tmx");
	ApplicationMain.loadSound("assets/music/Menubackground.ogg");
...
Main.prototype = $extend(flash.display.Sprite.prototype,{
	...
	,setupGame: function() {
		...
		this.addChild(new flixel.FlxGame(this.gameWidth,192,this.initialState,this.zoom,this.framerate,this.framerate,this.skipSplash,this.startFullscreen));
	}
	,__class__: Main
});
...
var DefaultAssetLibrary = function() {
	...
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.IMAGE);
	id = "assets/art/simples_pimples - Kopie.png";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.IMAGE);
	...
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/1.csv";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/background.awk";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/ladder-filter.awk";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/ladder.awk";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/map-it.bat";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	...
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/practice.awk";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/unbenannt.png";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.IMAGE);
	id = "assets/levels/unbenannt.tmx";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/levels/unbenannt2.png";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.IMAGE);
	id = "assets/levels/unbenannt2.tmx";
	this.path.set(id,id);
	this.type.set(id,openfl.AssetType.TEXT);
	id = "assets/music/Menubackground.ogg";
	this.path.set(id,id);
...
$hxClasses["GAnalytics"] = GAnalytics;
GAnalytics.__name__ = ["GAnalytics"];
GAnalytics.startSession = function(sUA,iPeriod) {
	if(iPeriod == null) iPeriod = 15;
};
GAnalytics.stopSession = function() {
};
GAnalytics.trackScreen = function(sScreen) {
};
GAnalytics.trackEvent = function(sCat,sAction,sLabel,value) {
	if(value == null) value = 1;
};
GAnalytics.sendTiming = function(sCat,iInterval,sName,sLabel) {
};
GAnalytics.setCustom_dimension = function(iIndex,sValue) {
};
GAnalytics.setCustom_metric = function(iIndex,iValue) {
};
GAnalytics.trackSocial = function(sSocial_network,sAction,sTarget) {
};
...
MenuState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,moveIt: null
	,create: function() {
		MenuState.virtualPad = new flixel.ui.FlxVirtualPad(flixel.ui.DPadMode.UP_DOWN,flixel.ui.ActionMode.A);
		this.add(MenuState.virtualPad);
		flixel.FlxG.mouse.set_visible(false);
		flixel.FlxG.game._state.set_bgColor(-15723500);
		this._text1 = new flixel.text.FlxText(-220,flixel.FlxG.height / 4,320,"Montezumas");
		this._text1.set_moves(true);
		this._text1.set_size(12);
		this._text1.set_color(41704);
		this._text1.antialiasing = true;
		this._text1.velocity.set_x(600);
		this.add(this._text1);
		this._text2 = new flixel.text.FlxText(flixel.FlxG.width - 200,flixel.FlxG.height / 2.5,320,"Tower 8bit");
		...
		this._text3 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3,150,"Play (click A for select/jump, B for shooting)");
		this._text4 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3 + 20,150,"Give us Feedback");
		this._text5 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3 + 30,150,"Visit flixel.org");
		this._text3.set_color(this._text4.set_color(this._text5.set_color(-1442798872)));
		this._text3.set_size(this._text4.set_size(this._text5.set_size(8)));
		...
		flixel.FlxG.sound.playMusic("assets/music/Menubackground.ogg");
	}
	,update: function() {
		var _up = false;
		var _down = false;
		...
		if(this._text2.x < flixel.FlxG.width / 5) this._text2.velocity.set_x(0);
		var _g = this._option;
		switch(_g) {
		case 0:
		...
		_up = _up || MenuState.virtualPad.buttonUp.status == 2;
		_down = _down || MenuState.virtualPad.buttonDown.status == 2;
		_left = _left || MenuState.virtualPad.buttonLeft.status == 2;
		_right = _right || MenuState.virtualPad.buttonA.status == 2;
		if(MenuState.virtualPad.buttonUp.status == 2 && this.moveIt == false) {
			this._option = (this._option + 3 - 1) % 3;
			flixel.FlxG.sound.play("assets/sounds/menu" + Reg.SoundExtension,1,false);
			this.moveIt = true;
		}
		if(MenuState.virtualPad.buttonUp.status == 0 && MenuState.virtualPad.buttonDown.status == 0) this.moveIt = false;
		if((flixel.FlxG.keys.checkStatus(40,flixel.FlxG.keys.justPressed.checkStatus) || MenuState.virtualPad.buttonDown.status == 2) && this.moveIt == false) {
			this._option = (this._option + 3 + 1) % 3;
			flixel.FlxG.sound.play("assets/sounds/menu" + Reg.SoundExtension,1,false);
			this.moveIt = true;
		}
		if(flixel.FlxG.keys.checkStatus(39,flixel.FlxG.keys.justPressed.checkStatus) || MenuState.virtualPad.buttonA.status == 2) {
			...
			case 0:
				...
				break;
			case 1:
				flixel.FlxG.openURL("http://kulsch-it.de/#contact",null);
				break;
			case 2:
...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,_boxRed: null
	,create: function() {
		admob.AD.init("ca-app-pub-8761501900041217/8764631680",admob.AD.CENTER,admob.AD.BOTTOM,admob.AD.BANNER_LANDSCAPE,true);
		...
		PlayState.virtualPad2 = new flixel.ui.FlxVirtualPad(flixel.ui.DPadMode.FULL,flixel.ui.ActionMode.A_B);
		PlayState.virtualPad2.group.setAll("alpha",0.5,true);
		this.add(PlayState.virtualPad2);
		...
		this.add(this.player = new Player(480,20,this,this._gibs,this._bullets));
		flixel.FlxG.camera.follow(this.player);
		flixel.FlxG.camera.style = 4;
		...
		this._debug = new flixel.text.FlxText(0,0,flixel.FlxG.width);
		this._debug.setFormat(null,10,-16744448,"left",2,1252379);
		this._debug.scrollFactor.set(0,0);
		this.add(this._debug);
		this._text1 = new flixel.text.FlxText(0,30,flixel.FlxG.width,"Press A - Button to Restart.");
		this._text1.setFormat(null,40,-65536,"center",2,-16777216);
		this._text1.set_visible(false);
		this._text1.antialiasing = true;
		this._text1.scrollFactor.set(0,0);
		this.add(this._text1);
		flixel.FlxG.sound.playMusic("assets/music/ScrollingSpace.ogg");
	}
	,update: function() {
		...
		flixel.FlxState.prototype.update.call(this);
		this._score.set_text("$" + Std.string(Reg.score) + "/100");
		if(!this.player.alive) {
			this._text1.set_visible(true);
			admob.AD.hide();
			if(flixel.FlxG.keys.checkStatus(82,flixel.FlxG.keys.justPressed.checkStatus) || PlayState.virtualPad2.buttonA.status == 2) {
				admob.AD.show();
	...
	,collectCoin: function(P,C) {
		...
		if(Reg.score > 99) {
			...
			flixel.FlxG.switchState(new WinningState());
			admob.AD.hide();
		}
	}
	,hitPlayer: function(P,Monster) {
		if(js.Boot.__instanceof(Monster,Bullet)) {
	...
	,placeMonsters: function(MonsterData,Monster) {
		...
		while(_g1 < _g) {
			...
			if(Monster == Lurker) this._enemies.add(new Lurker(16 * Std.parseInt(coords[0]),16 * Std.parseInt(coords[1]),this.player,this._badbullets));
		}
	}
	,placeCoins: function(CoinData,Sparkle) {
		...
		while(_g1 < _g) {
			var j = _g1++;
			coords = entities[j].split(",");
			if(Sparkle == Coin) this._coins.add(new Coin(16 * Std.parseInt(coords[0]),16 * Std.parseInt(coords[1])));
		}
	}
	,__class__: PlayState
});
...
Player.prototype = $extend(flixel.FlxSprite.prototype,{
	...
	,update: function() {
		...
		var _left = false;
		var _right = false;
		_up = PlayState.virtualPad2.buttonUp.status == 2;
		_down = PlayState.virtualPad2.buttonDown.status == 2;
		_left = PlayState.virtualPad2.buttonLeft.status == 2;
		_right = PlayState.virtualPad2.buttonRight.status == 2;
		if(this.climbing) this.acceleration.set_y(0); else this.acceleration.set_y(620);
		if(PlayState.virtualPad2.buttonLeft.status == 2) {
			this.set_flipX(true);
			this.acceleration.set_x(-this.drag.x);
		} else if(PlayState.virtualPad2.buttonRight.status == 2) {
			this.set_flipX(false);
			this.acceleration.set_x(this.drag.x);
		}
		this.jump();
		this.climb();
		if(PlayState.virtualPad2.buttonB.status == 2) this.shoot();
		...
		if(this._parent.ladders.getTile(this._xgridleft,this._ygrid) > 0 && this._parent.ladders.getTile(this._xgridright,this._ygrid) > 0) {
			this._onLadder = true;
			this.climbing = true;
			this._jumpTime = -1;
			this._timesJumped = 0;
		...
		if((this.touching & 4096) > 0 && PlayState.virtualPad2.buttonA.status == 0) {
			this._jumpTime = -1;
			this._timesJumped = 0;
		}
	...
	,climb: function() {
		if(flixel.FlxG.keys.checkKeyStatus(["UP","W"],1) || PlayState.virtualPad2.buttonUp.status == 2) {
			if(this._onLadder) {
				this.climbing = true;
				this._timesJumped = 0;
			}
			if(this.climbing && (this._parent.ladders.getTile(this._xgridleft,this._ygrid - 1) > 0 || this._parent.ladders.getTile(this._xgridleft,this._ygrid) > 0)) this.velocity.set_y(-90);
		} else if(flixel.FlxG.keys.checkKeyStatus(["DOWN","S"],1) || PlayState.virtualPad2.buttonDown.status == 2) {
			if(this._onLadder) {
				this.climbing = true;
				this._timesJumped = 0;
			}
	...
	,jump: function() {
		if(PlayState.virtualPad2.buttonA.status == 2) {
			if(this.velocity.y == 0 && this._timesJumped < 1) {
		...
		if(PlayState.virtualPad2.buttonA.status == 2 && this._jumpTime >= 0) {
			this.climbing = false;
			this._jumpTime += flixel.FlxG.elapsed;
			if(this._jumpTime > 0.25) {
				this._jumpTime = -1;
				this.jumped = true;
			} else if(this._jumpTime > 0) this.velocity.set_y(-0.6 * this.maxVelocity.y);
		}
	}
	,shoot: function() {
		var bulletX = Math.floor(this.x);
...
var WinningState = function(MaxSize) {
	flixel.FlxState.call(this,MaxSize);
};
$hxClasses["WinningState"] = WinningState;
WinningState.__name__ = ["WinningState"];
WinningState.__super__ = flixel.FlxState;
WinningState.prototype = $extend(flixel.FlxState.prototype,{
	_text1: null
	,_text2: null
	,create: function() {
		flixel.FlxG.game._state.set_bgColor(-15723500);
		this._text1 = new flixel.text.FlxText(-220,flixel.FlxG.height / 4,320,"You won!");
		this._text1.set_moves(true);
		this._text1.set_size(20);
		this._text1.set_color(41704);
		this._text1.antialiasing = true;
		this._text1.velocity.set_x(600);
		this.add(this._text1);
		this._text2 = new flixel.text.FlxText(flixel.FlxG.width - 200,flixel.FlxG.height / 2.5,320,"Level 1 complete");
		this._text2.set_moves(true);
		this._text2.set_size(this._text1.get_size());
		this._text2.set_color(this._text1.color);
		this._text2.antialiasing = this._text1.antialiasing;
...
var admob = {};
admob.AD = function() { };
$hxClasses["admob.AD"] = admob.AD;
admob.AD.__name__ = ["admob","AD"];
admob.AD.init = function(id,x,y,size,test) {
	if(test == null) test = false;
	if(size == null) size = 0;
	if(y == null) y = 0;
	if(x == null) x = 0;
};
admob.AD.show = function() {
};
admob.AD.hide = function() {
};
admob.AD.refresh = function() {
};
admob.AD.initInterstitial = function(id,test) {
	if(test == null) test = false;
};
admob.AD.showInterstitial = function() {
};
...
Reg.goldKeys = 0;
Reg.saves = [];
WinningState.OPTIONS = 3;
WinningState.TEXT_SPEED = 600;
admob.AD.LEFT = 0;
admob.AD.RIGHT = 1;
admob.AD.CENTER = 2;
admob.AD.TOP = 0;
admob.AD.BOTTOM = 1;
admob.AD.BANNER_PORTRAIT = 0;
admob.AD.BANNER_LANDSCAPE = 1;
admob.AD.originX = 0;
admob.AD.originY = 0;
admob.AD.bannerSize = 0;
admob.AD.testMode = false;
