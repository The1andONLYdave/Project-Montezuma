...
var Lurker = function(X,Y,ThePlayer) {
	...
	this.drag.set_x(270);
	this.drag.set_y(420);
	this.acceleration.set_x(30);
	this.maxVelocity.set_x(300);
...
MenuState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,create: function() {
		...
		this._text3 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3,150,"Play");
		this._text4 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3 + 10,150,"Visit our Webpage");
		this._text5 = new flixel.text.FlxText(flixel.FlxG.width * 2 / 5,flixel.FlxG.height * 2 / 3 + 20,150,"Visit flixel.org");
	...
	,update: function() {
		...
		if(flixel.FlxG.keys.checkStatus(39,flixel.FlxG.keys.justPressed.checkStatus) || MenuState.virtualPad.buttonA.status == 2) {
			...
			case 0:
				...
				break;
			case 1:
				flixel.FlxG.openURL("http://kulsch-it.de",null);
				break;
			case 2:
...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,create: function() {
		...
		PlayState.virtualPad2 = new flixel.ui.FlxVirtualPad(flixel.ui.DPadMode.FULL,flixel.ui.ActionMode.A);
		...
		this.add(this.player = new Player(480,20,this,this._gibs));
	...
	,update: function() {
		...
		flixel.FlxState.prototype.update.call(this);
		this._score.set_text("$" + Std.string(Reg.score) + " Silverkeys: " + Std.string(Reg.silverKeys) + " Goldkeys: " + Std.string(Reg.goldKeys));
	...
	,placeMonsters: function(MonsterData,Monster) {
		...
		while(_g1 < _g) {
			...
			if(Monster == Lurker) this._enemies.add(new Lurker(16 * Std.parseInt(coords[0]),16 * Std.parseInt(coords[1]),this.player));
		}
	}
...
var Player = function(X,Y,Parent,Gibs) {
	this.jumped = false;
